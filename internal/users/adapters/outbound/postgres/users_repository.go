...
func NewUsersRepository(db *db.DB) outbound.UserRepository {
	return &UsersRepository{
		db: db,
	}
}

func (r *UsersRepository) CreateUser(ctx context.Context, req *dto.CreateUserRequest, hash string) error {
...
func (r *UsersRepository) GetUserByID(ctx context.Context, id string) (*domain.User, error) {
	var user domain.User
...
func (r *UsersRepository) UpdateUser(ctx context.Context, id string, req *dto.UpdateProfileRequest) error {
...
func (r *UsersRepository) CreateUserWithOrganization(ctx context.Context, req *dto.CreateUserRequest, hash string) error {
...
func (r *UsersRepository) GetUserOrganizations(ctx context.Context, userId string) (*[]domain.Organization, error) {
...
func (r *UsersRepository) OnboardUserWithTransaction(ctx context.Context, req *dto.OnboardingRequest, hash string) (*domain.User, error) {
