...
type GetActivityResponseData struct {
	Data     []domain.UserActivityResponse `json:"data"`
...
// @Produce json
// @Security ApiKeyAuth
// @Success 200 {object} domain.UserPreferencesResponse
...
// @Produce json
// @Security ApiKeyAuth
// @Success 200 {object} domain.UserNotificationsResponse
...
// @Produce json
// @Security ApiKeyAuth
// @Success 200 {array} domain.UserSessionResponse
