...
type ProfileRepositoryInt interface {
	// Preferences
	GetUserPreferences(ctx context.Context, userID, orgID string) (*models.UserPreferences, error)
	UpsertUserPreferences(ctx context.Context, userID, orgID string, prefs *models.UserPreferences) error

	// Notifications
	GetUserNotifications(ctx context.Context, userID, orgID string) (*models.UserNotifications, error)
	UpsertUserNotifications(ctx context.Context, userID, orgID string, notifs *models.UserNotifications) error

	// Sessions
	GetUserSessions(ctx context.Context, userID, orgID string) ([]models.UserSession, error)
	GetUserSessionByID(ctx context.Context, sessionID string) (*models.UserSession, error)
	...
	// Activity/Audit Logs
	GetUserActivity(ctx context.Context, userID, orgID string, page, pageSize int) ([]models.AuditLog, int, error)
...
func NewProfileRepository(db *db.DB) ProfileRepositoryInt {
...
func (r *ProfileRepository) GetUserPreferences(ctx context.Context, userID, orgID string) (*models.UserPreferences, error) {
...
func (r *ProfileRepository) UpsertUserPreferences(ctx context.Context, userID, orgID string, prefs *models.UserPreferences) error {
	var id string
...
func (r *ProfileRepository) GetUserNotifications(ctx context.Context, userID, orgID string) (*models.UserNotifications, error) {
	var notifs models.UserNotifications
...
func (r *ProfileRepository) UpsertUserNotifications(ctx context.Context, userID, orgID string, notifs *models.UserNotifications) error {
	var id string
...
func (r *ProfileRepository) GetUserSessions(ctx context.Context, userID, orgID string) ([]models.UserSession, error) {
...
func (r *ProfileRepository) GetUserSessionByID(ctx context.Context, sessionID string) (*models.UserSession, error) {
...
func (r *ProfileRepository) CreateUserSession(ctx context.Context, session *models.UserSession) error {
	var id string
...
func (r *ProfileRepository) GetUserActivity(ctx context.Context, userID, orgID string, page, pageSize int) ([]models.AuditLog, int, error) {
	if page < 1 {
		page = 1
	}
...
func (r *ProfileRepository) CreateAuditLog(ctx context.Context, log *models.AuditLog) error {
	var id string
