...
type ProfileHandler struct {
	userServ services.UserServicesInt
}

func NewProfileHandler(userServ services.UserServicesInt) *ProfileHandler {
...
func (h *ProfileHandler) UpdateProfile(c *fiber.Ctx) error {
	...
	var req requests.UpdateIdentityRequest
...
func (h *ProfileHandler) UpdateNotifications(c *fiber.Ctx) error {
	...
	var req requests.UpdateNotificationsRequest
	if err := c.BodyParser(&req); err != nil {
		return response.Error(c, fiber.StatusBadRequest, err.Error(), nil)
	}
