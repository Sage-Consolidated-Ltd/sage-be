...
func (m *mockUserRepo) GetUserOrganizations(ctx context.Context, userId string) (*[]domain.Organization, error) {
...
func (m *mockProfileRepo) GetUserActivity(ctx context.Context, userID, orgID string, page, pageSize int) ([]domain.AuditLog, int, error) {
	return nil, 0, nil
}
