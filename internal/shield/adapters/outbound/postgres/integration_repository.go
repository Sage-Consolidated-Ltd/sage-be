...
func NewIntegrationRepository(db *db.DB) outbound.IntegrationRepository {
	return &IntegrationRepository{
		db: db,
	}
}

func (r *IntegrationRepository) CreateCredential(ctx context.Context, c *domain.IntegrationCredentials) error {
...
func (r *IntegrationRepository) CreateDataSourceWithCredentialsBulk(ctx context.Context, creds *[]domain.IntegrationCredentials, ds *domain.DataSource) error {
...
func (r *IntegrationRepository) GetCredentialsByIntegration(ctx context.Context, integrationID string) ([]domain.IntegrationCredentials, error) {
	...
	for rows.Next() {
		var c domain.IntegrationCredentials
