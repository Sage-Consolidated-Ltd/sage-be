...
func NewParserRepository(db *db.DB) outbound.ParserRepository {
...
func (r *ParserRepository) CreateParser(ctx context.Context, parser *domain.Parser) error {
	var id uuid.UUID
...
func (r *ParserRepository) UpdateParser(ctx context.Context, parser *domain.Parser) error {
...
func (r *ParserRepository) CreateTestRun(ctx context.Context, run *domain.ParserTestRun) error {
	var id uuid.UUID
	var createdAt time.Time
	err := r.db.QueryRowContext(
		ctx, CREATE_TEST_RUN,
...
func (r *ParserRepository) ImportParser(ctx context.Context, parser *domain.Parser) error {
	var id uuid.UUID
	var createdAt, updatedAt time.Time
	err := r.db.QueryRowContext(
		ctx, IMPORT_PARSER,
