...
func NewIngestionJobRepository(db *db.DB) outbound.IngestionJobRepository {
...
func (r *IngestionJobRepository) ListJobs(ctx context.Context, orgID uuid.UUID, jobType domain.JobType, status domain.JobStatus, page, pageSize int) ([]*domain.IngestionJob, int, error) {
	if page < 1 {
		page = 1
	}
