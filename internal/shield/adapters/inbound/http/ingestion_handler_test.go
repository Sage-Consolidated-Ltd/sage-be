...
func (m *mockLogsDataService) ListSources(ctx context.Context, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*domain.DataSource, int, error) {
...
func (m *mockLogsDataService) GetSource(ctx context.Context, id uuid.UUID, orgID uuid.UUID) (*domain.DataSource, error) {
...
func (m *mockLogsDataService) GetSourceLogs(ctx context.Context, sourceID uuid.UUID, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*domain.SecurityEvent, int, error) {
