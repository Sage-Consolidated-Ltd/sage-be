...
// @Produce json
// @Security SessionAuth
// @Param request body dto.CreateParserRequest true "Create Parser Request"
// @Success 200 {object} response.Response
...
// @Security SessionAuth
// @Param id path string true "Parser ID"
// @Param request body dto.UpdateParserRequest true "Update Parser Request"
// @Success 200 {object} response.Response
...
// @Security SessionAuth
// @Param id path string true "Parser ID"
// @Param request body dto.TestParserRequest true "Test Parser Request"
// @Success 200 {object} response.Response
...
// @Produce json
// @Security SessionAuth
// @Param request body dto.PreviewParserRequest true "Preview Parser Request"
// @Success 200 {object} response.Response
