...
func (s *DashboardService) GetThreatTrends(ctx context.Context, orgID uuid.UUID, currentMonth, previousMonth, severity string) (*domain.ThreatTrendsSummary, error) {
	return s.repo.GetThreatTrends(ctx, orgID, currentMonth, previousMonth, severity)
}
