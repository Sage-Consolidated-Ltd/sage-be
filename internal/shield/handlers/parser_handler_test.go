...
func (m *mockParserService) ListParsers(ctx context.Context, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*models.Parser, int, error) {
	args := m.Called(ctx, orgID, filters, page, pageSize)
	if args.Get(0) == nil {
		return nil, args.Get(1).(int), args.Error(2)
	}
	return args.Get(0).([]*models.Parser), args.Get(1).(int), args.Error(2)
}

func (m *mockParserService) GetParser(ctx context.Context, id uuid.UUID, orgID uuid.UUID) (*models.Parser, error) {
	args := m.Called(ctx, id, orgID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*models.Parser), args.Error(1)
}

func (m *mockParserService) CreateParser(ctx context.Context, parser *models.Parser) error {
	args := m.Called(ctx, parser)
	return args.Error(0)
}

func (m *mockParserService) UpdateParser(ctx context.Context, parser *models.Parser, changeNote string, changedBy uuid.UUID) error {
	args := m.Called(ctx, parser, changeNote, changedBy)
	return args.Error(0)
}

func (m *mockParserService) TestParser(ctx context.Context, parserID uuid.UUID, orgID uuid.UUID, sampleLog string, rawPayload map[string]interface{}) (*models.ParserTestResponse, error) {
	args := m.Called(ctx, parserID, orgID, sampleLog, rawPayload)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*models.ParserTestResponse), args.Error(1)
}

func (m *mockParserService) PreviewParser(ctx context.Context, parserType types.ParserType, logic map[string]interface{}, mappings []map[string]interface{}, sampleLog string, rawPayload map[string]interface{}) (*models.ParserTestResponse, error) {
...
func (m *mockParserService) ImportParser(ctx context.Context, parser *models.Parser) error {
	args := m.Called(ctx, parser)
	return args.Error(0)
}

func (m *mockParserService) ExportParser(ctx context.Context, id uuid.UUID, orgID uuid.UUID) (*models.Parser, error) {
	args := m.Called(ctx, id, orgID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *mockParserService) ListSampleLogs(ctx context.Context, sourceID, parserID *uuid.UUID, orgID uuid.UUID, page, pageSize int) ([]*models.SecurityEvent, int, error) {
...
func TestParserHandler_CreateParser_Success(t *testing.T) {
	...
	mockService.On("CreateParser", mock.Anything, mock.AnythingOfType("*models.Parser")).Return(nil)
