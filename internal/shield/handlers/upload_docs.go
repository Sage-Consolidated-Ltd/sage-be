...
type UploadPresignResponse = models.PresignUploadResponse
type ConfirmUploadResponse = models.LogFile
...
// @Param		request	body		requests.UploadLogRequest	true	"File metadata"
...
// @Produce		json
// @Security	SessionAuth
// @Param		request	body		requests.UploadCompleteRequest	true	"Upload complete request"
