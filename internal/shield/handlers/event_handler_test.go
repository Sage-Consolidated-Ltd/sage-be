...
func (m *mockLogsService) SearchLogs(ctx context.Context, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*models.SecurityEvent, int, error) {
...
func (m *mockLogsService) GetLogByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*models.SecurityEvent, error) {
...
func TestEventHandler_SearchLogs_Success(t *testing.T) {
	...
	eventPtrs := make([]*models.SecurityEvent, len(events))
	for i := range events {
