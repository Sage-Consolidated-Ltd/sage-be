...
type LogsDataServiceInt interface {
	...
	ListSources(ctx context.Context, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*models.DataSource, int, error)
	GetSource(ctx context.Context, id uuid.UUID, orgID uuid.UUID) (*models.DataSource, error)
	...
	GetSourceLogs(ctx context.Context, sourceID uuid.UUID, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*models.SecurityEvent, int, error)
...
func (s *LogsDataService) ListSources(ctx context.Context, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*models.DataSource, int, error) {
	return s.dataSourceRepo.ListDataSources(ctx, orgID, filters, page, pageSize)
}

func (s *LogsDataService) GetSource(ctx context.Context, id uuid.UUID, orgID uuid.UUID) (*models.DataSource, error) {
...
func (s *LogsDataService) GetSourceLogs(ctx context.Context, sourceID uuid.UUID, orgID uuid.UUID, filters map[string]interface{}, page, pageSize int) ([]*models.SecurityEvent, int, error) {
...
func (s *LogsDataService) GetIngestionNotifications(ctx context.Context, orgID uuid.UUID) (map[string]interface{}, error) {
	...
	for _, src := range sources {
		msg := ""
		if src.Status == models.DataSourceStatusError {
