...
import (
	_ "sage-backend/internal/identity/domain"
...
// @Accept json
// @Produce json
// @Param request body dto.OnboardingRequest true "User Details"
// @Success 201
...
// @Accept       json
// @Produce      json
// @Param        request   body      dto.GoogleAuthenticatorRequest true "TOTP Code"
// @Security 	SessionAuth
// @Success      200
...
// @Accept       json
// @Produce      json
// @Param        request   body      dto.SendVerificationEmailRequest true "Email Address"
// @Success      200
